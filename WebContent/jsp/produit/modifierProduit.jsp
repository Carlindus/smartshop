	...
	<html:form action="creerProduit.do">
		<table border="0" align="center">
			...
			<tr>
				...
				<td align="left"><html:text property="produitReference" size="25" maxlength="25" value=${ produit.reference }/></td>
			...
			<tr>
				...
				<td align="left"><html:text property="produitPrix" size="25" maxlength="25" value=${ produit.prix }/></td>
			...
			<tr>
				...
				<td align="left"><html:file property="produitImage" size="25" maxlength="25" value=${ produit.image }/></td>
			...
			<tr>
				...
				<td align="left"><html:textarea property="produitDescription" cols="25" rows="10" value=${ produit.description }/></td>
			...
			<tr>
				<td align="right"><html:submit property="produitSubmit" titleKey="creerProduit.submit"><bean:message key="modifierProduit.submit"/></html:submit></td>
