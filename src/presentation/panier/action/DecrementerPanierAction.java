 ...
 *
 */
public class DecrementerPanierAction extends Action {
    ...
    public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, 
        ...
        // récupération du service panier et appel de la méthode de décrémentation de la quantité d'un produit
        final IPanierService panierService = MyFactory.getInstance(IPanierService.class);
        final PanierDto panierResultat = panierService.decreaseQuantity(idProduit, panierDto);
